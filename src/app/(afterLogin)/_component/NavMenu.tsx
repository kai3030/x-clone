...
export default function NavMenu() {
  ...
  // style
  const navPillStyle = "inline-flex h-[50px] p-[12px] items-center hover:bg-[rgba(15,20,25,0.1)] rounded-full";
  const activeStyle = "font-bold ml-[20px] mr-[16px]";
  const normalStyle = "ml-[20px] mr-[16px]";

  return (
    <>
      <li>
        <Link href="/home">
          <div className={navPillStyle}>
            {segment === "home" ? (
              <>
                <svg
                  width={26}
                ...
                <div className={activeStyle}>홈</div>
              </>
            ) : (
              <>
                <svg
                ...
                <div className={normalStyle}>홈</div>
              </>
            )}
          </div>
        </Link>
          ...
          <div className={navPillStyle}>
            {segment && ["search", "explore"].includes(segment) ? (
              <>
                ...
                <div className={activeStyle}>탐색하기</div>
              </>
            ) : (
              <>
                <svg
                ...
                <div className={normalStyle}>탐색하기</div>
              </>
            )}
          </div>
        </Link>
          ...
          <div className={navPillStyle}>
            {segment === "messages" ? (
              <>
                ...
                <div className={activeStyle}>쪽지</div>
              </>
            ) : (
              <>
                <svg
                ...
                <div className={normalStyle}>쪽지</div>
              </>
            )}
          </div>
        </Link>
            ...
            <div className={navPillStyle}>
              {segment === me.id ? (
                <>
                  ...
                  <div className={activeStyle}>프로필</div>
                </>
              ) : (
                <>
                  <svg
                  ...
                  <div className={normalStyle}>프로필</div>
                </>
              )}
            </div>
          </Link>
